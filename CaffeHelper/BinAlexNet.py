...
train_size = 1200000
solver.train(base_lr=0.01, lr_policy='step', gamma=0.01,
             stepsize=4 * train_size / batch_size,
...
out = Conv(out, name='conv2', conv_type=conv_type, num_output=256,
           kernel_size=5, pad=2,
           weight_filler=filler_xavier, bias_filler=filler_constant2,
           optional_params=other_param)
...
out = BN(out, name='bn6')
out = FC(out, name='fc6', fc_type=fc_type, num_output=4096,
...
out = FC(out, name='fc8', num_output=1000, weight_filler=filler_xavier,
