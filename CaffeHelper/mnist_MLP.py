...
out = BinFC(out, name='fc1', num_output=2048, weight_filler=filler_xavier)
out = BN(out, name='bn1')
out = ReLU(out, name='relu1')
out = BN(out, name='bn2')
out = BinFC(out, name='fc2', num_output=10, weight_filler=filler_xavier)
...
solver.train(base_lr=1e-3, lr_policy='step', stepsize=100, gamma=0.1, weight_decay=1e-4, max_iter=4000)
