...
Net("mnist_MLP")
filler_xavier = Filler('uniform', min=-0.1, max=0.1)
...
out = BinFC(out, name='fc2', num_output=64, weight_filler=filler_xavier, bias_term=True, bias_filler=filler_constant)
out = BN(out, name='bn2')
