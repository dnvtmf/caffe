...
Net("mnist_MLP")
filler_xavier = Filler('uniform', min=-1, max=1)
...
out = BTFC(out, name='fc2', num_output=64, weight_filler=filler_xavier, bias_term=True, bias_filler=filler_constant)
# out = BN(out, name='bn2')
# out = ReLU(out, name='relu2')
out = FC(out, name='fc3', num_output=10, weight_filler=filler_xavier, bias_term=True, bias_filler=filler_constant)
...
solver.train(base_lr=0.001, lr_policy='fixed', max_iter=20 * 50000 / 100)
