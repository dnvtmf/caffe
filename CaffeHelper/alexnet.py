...
out = Conv(out, name='conv1', num_output=96, bias_term=True, kernel_size=11,
           stride=4,
           weight_filler=filler_gaussian, bias_filler=filler_constant,
...
out = BN(out, name='bn1')
out = Conv(out, name='conv2', conv_type=conv_type, num_output=256,
           kernel_size=5, pad=2,
           weight_filler=filler_gaussian, bias_filler=filler_constant2,
           optional_params=other_param)
...
out = BN(out, name='bn3')
out = Conv(out, name='conv3', conv_type=conv_type, num_output=384,
           kernel_size=3, pad=1,
           weight_filler=filler_gaussian, bias_filler=filler_constant,
           optional_params=other_param)
...
out = BN(out, name='bn4')
out = Conv(out, name='conv4', conv_type=conv_type, num_output=384,
           kernel_size=3, pad=1, group=2,
           weight_filler=filler_gaussian, bias_filler=filler_constant2,
           optional_params=other_param)
out = Activation(out, name='act4', method=activation_method)

out = BN(out, name='bn5')
out = Conv(out, name='conv5', conv_type=conv_type, num_output=256,
           kernel_size=3, pad=1, group=2,
           weight_filler=filler_gaussian, bias_filler=filler_constant2,
           optional_params=other_param)
...
out = BN(out, name='bn6')
out = FC(out, name='conv6', fc_type=fc_type, num_output=4096,
         weight_filler=filler_gaussian2,
...
out = BN(out, name='bn7')
out = FC(out, name='fc7', fc_type=fc_type, num_output=4096,
         weight_filler=filler_gaussian2,
         bias_filler=filler_constant2, optional_params=other_param)
out = Activation(out, name='act7', method=activation_method)
out = DropOut(out, name='drop7', dropout_ratio=0.5)

out = FC(out, name='fc8', num_output=1000, weight_filler=filler_gaussian,
...
solver.train(base_lr=0.01, lr_policy='step', gamma=0.1, stepsize=100000,
             max_iter=450000, weight_decay=0.0005)
