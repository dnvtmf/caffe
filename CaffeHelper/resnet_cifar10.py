...
data, label = Data([], phase=TRAIN, source="../cifar10_train_lmdb", batch_size=batch_size, backend=Net.LMDB,
                   optional_params=[Transform(mean_file="../mean.binaryproto", mirror=True)])
...
out = FC(out, name='fc', num_output=10, weight_filler=filler_xavier, bias_filler=filler_constant)
