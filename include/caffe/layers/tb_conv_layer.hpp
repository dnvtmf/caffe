 ...
 protected:
  ...
  inline void conv_im2col_cpu(const Dtype* data, Dtype* col_buff) {
    if (num_spatial_axes_ == 2) {
      im2col_cpu(
          data, in_channels_, conv_input_shape_.cpu_data()[1],
  ...
  inline void conv_col2im_cpu(const Dtype* col_buff, Dtype* data) {
    if (num_spatial_axes_ == 2) {
      col2im_cpu(
          col_buff, in_channels_, conv_input_shape_.cpu_data()[1],
          conv_input_shape_.cpu_data()[2], kernel_shape_.cpu_data()[0],
          kernel_shape_.cpu_data()[1], pad_.cpu_data()[0], pad_.cpu_data()[1],
          stride_.cpu_data()[0], stride_.cpu_data()[1], dilation_.cpu_data()[0],
  ...
  inline void conv_im2col_gpu(const Dtype* data, Dtype* col_buff) {
    if (num_spatial_axes_ == 2) {
      ...
      im2col_nd_gpu(
          data, num_spatial_axes_, num_kernels_im2col_,
  ...
  inline void conv_col2im_gpu(const Dtype* col_buff, Dtype* data) {
    if (num_spatial_axes_ == 2) {
      ...
      col2im_nd_gpu(
          col_buff, num_spatial_axes_, num_kernels_col2im_,
          conv_input_shape_.gpu_data(), col_buffer_.gpu_shape(),
          kernel_shape_.gpu_data(), pad_.gpu_data(), stride_.gpu_data(),
