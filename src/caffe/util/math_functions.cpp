...
template void caffe_set<uint64_t>(const int N, const uint64_t alpha, uint64_t* Y);
...
template void caffe_copy<unsigned int>(const int N, const unsigned int* X,
    unsigned int* Y);
template void caffe_copy<unsigned long long>(const int N, const unsigned long long* X,
