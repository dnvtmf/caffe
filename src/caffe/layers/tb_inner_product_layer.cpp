...
void TBInnerProductLayer<Dtype>::Backward_cpu(
  ...
  if (propagate_down[0]) {
    ...
    // dIn = dO x W'
    caffe_cpu_ternary_norm<Dtype>(0, M_, N_, top[0]->cpu_diff(), binary_g_,
